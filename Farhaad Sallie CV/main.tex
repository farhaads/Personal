...
\begin{document}
    \name{Rudo Janse van Rensburg}
    \tagline{Computer Scientist and Data Engineer}
    %% You can add multiple photos on the left or right
    \photoL{4cm}{me}
    
    \personalinfo{
        \email{rudo.janse.van.rensburg@rudo.guru}\smallskip
        \phone{+2771-612-5820}
        \location{Durban, South Africa}\\
        \linkedin{rudo-janse-van-rensburg-26a78b1b4}
        \github{Rudo-Janse-van-Rensburg-69}  
    } 
    \makecvheader
